      ...
      meta: [
        {
          name: 'description',
          content:
            'BombayTech is a personal blog created by Mauricio Rivera. It is a place where I share my thoughts and experiences about software development, photography, and other topics.',
        },
        {
          name: 'keywords',
          content:
            'BombayTech, Mauricio Rivera, MSRP, Mauricio Sebastian Rivera Perez, Sebastian Rivera, Bombay1023, BombayV, Software Development, Photography, Blog, Personal Blog, Tech Blog, Tech, Software, Photography, Web Development, Web Design, Web, Design, Development, Software Engineer, Software Developer, Developer, Engineer, Photography, Photographer, Photo, Photos',
        },
