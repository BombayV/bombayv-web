...
<template>
  <div>
    <header
      ref="navbarRef"
      class="fixed z-20 transform-gpu transition-transform duration-500 navbar">
      ...
      <button type="button" @click="setSidebar(true)" class="btn btn-square btn-ghost lg:hidden">
        <svg
          class="h-6 w-6"
          fill="currentColor"
          viewBox="0 0 20 20"
