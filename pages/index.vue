      ...
      <div class="lg:pr-8 xl:pr-16 2xl:pr-24">
        <div :ref="addToRef" class="opacity-0">
          ...
          <p class="text-md lg:text-xl xl:text-2xl font-medium text-zinc-700 pt-2 dark:text-zinc-300 leading-loose lg:mb-5">
            ...
            I am a trying to become a <span class="text-grad font-semibold">developer</span> who works both with backend and frontend technologies. Additionally, I do <span class="text-grad font-semibold">photography</span> and <span class="text-grad font-semibold">UX design</span>
			...
			<div>
				...
				<div :ref="addToRef" class="opacity-0 mt-4">
					...
					<div class="columns-1 sm:columns-2 lg:columns-1">
						<GithubStat title="Commits" :number="1800">
						...
						<GithubStat class="mt-4" title="Stars" :number="72">
							<svg class="w-full h-full fill-indigo-500 dark:fill-indigo-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
						...
						<GithubStat class="mt-4" title="Repos" :number="69">
							<svg class="w-full h-full fill-indigo-500 dark:fill-indigo-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
						...
						<GithubStat class="mt-4" title="Followers" :number="53">
							<svg class="w-full h-full fill-indigo-500 dark:fill-indigo-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
