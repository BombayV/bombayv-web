...
<template>
  <NuxtLayout>
    <section class="flex flex-col mx-auto w-full relative max-w-7xl px-6">
      <div class="w-full py-3 px-3.5 bg-background-100 rounded-full mt-8 flex items-center justify-between">
        ...
        <Button className="aspect-square rounded-full p-3 bg-red-400 hover:bg-red-300" @click="useLogout">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="fill-background-800 w-5 h-5 sm:w-6 sm:h-6">
            <path fill-rule="evenodd" d="M7.5 3.75A1.5 1.5 0 006 5.25v13.5a1.5 1.5 0 001.5 1.5h6a1.5 1.5 0 001.5-1.5V15a.75.75 0 011.5 0v3.75a3 3 0 01-3 3h-6a3 3 0 01-3-3V5.25a3 3 0 013-3h6a3 3 0 013 3V9A.75.75 0 0115 9V5.25a1.5 1.5 0 00-1.5-1.5h-6zm5.03 4.72a.75.75 0 010 1.06l-1.72 1.72h10.94a.75.75 0 010 1.5H10.81l1.72 1.72a.75.75 0 11-1.06 1.06l-3-3a.75.75 0 010-1.06l3-3a.75.75 0 011.06 0z" clip-rule="evenodd" />
          </svg>
        </Button>
      </div>
    </section>
    <section class="flex flex-col mx-auto w-full relative max-w-7xl px-6 mb-8">
      <div class="w-full py-3 px-5 bg-background-100 rounded-full mt-8 flex items-center justify-between">
        <h1>Gallery</h1>
        <Button @click="setModal(true)" className="btn-outline rounded-full gap-x-2 pl-3 group">
          Upload
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 sm:w-5 sm:h-5 fill-background-800 group-hover:fill-background-50 transition duration-200">
