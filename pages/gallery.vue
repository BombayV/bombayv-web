...
<template>
  <NuxtLayout>
    <section class="flex flex-col items-center mx-auto w-full text-center relative max-w-7xl px-6 py-8 md:py-16 h-full grow">
      ...
      <div v-if="fetchStatus.status === 'success'" class="columns-1 md:columns-2 xl:columns-3 space-y-4 mt-16">
        <GalleryPhoto
          v-for="img in images"
          :key="img"
          :image="img"
